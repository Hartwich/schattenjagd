...
/**
 * Round intro and result screens for Schattenjagd.
 *
...
function renderIntro(scene: Phaser.Scene, state: RoundScreenState): void {
  ...
  addText(
    ...
    schattenjagdManifest.displayName,
    {
...
function renderResult(scene: Phaser.Scene, state: RoundScreenState): void {
  ...
  addText(scene, layer, panelX, 122, state.message ?? schattenjagdManifest.displayName, {
    fontFamily: theme.bodyFont,
    fontSize: "20px",
    color: theme.muted,
